...
router.post('/login', authLimiter, validate(loginSchema), async (req, res) => {
  ...
  try {
    ...
    // Demo Mode: Bypass OTP and issue tokens immediately
    ...
    logger.info('Login successful (Demo Mode)', { email, ip: req.ip });
    await auditLog(email, 'LOGIN_SUCCESS_DEMO', 'admin_users', user.id, req.ip);
